...
def main(args):
    ...
    solver.generate_text(n_tokens_to_generate=1024,                 # Custom generating function
...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_text", type=str, default='<sol>', help='Input prompt for generating text.')

    # Training Arguments
    parser.add_argument('--epochs', type=int, default=20, help='number of training epochs')
    parser.add_argument('--warmup_epochs', type=int, default=2, help='number of epochs to warmup learning rate')
    ...
    parser.add_argument("--gen_tokens_len", type=int, default=128, help='number of tokens to generate while testing.')
